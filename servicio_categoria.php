...
class Service extends SuperRest
{
	function get()
	{
		...
		return $this->genericGet("servicio_categoria");
	}
	...
	function post()
	{
		...
		try
		{
			$servicio_categoria = app::getUserFromSession();
			if( $servicio_categoria == null )
	...
	{
		return $this->genericInsert($array,"servicio_categoria");
	}

	function batchUpdate($array)
	{
		$insert_with_ids = false;
		return $this->genericUpdate($array, "servicio_categoria", $insert_with_ids );
	}
