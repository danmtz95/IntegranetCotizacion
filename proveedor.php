...
class Service extends SuperRest
{
	function get()
	{
		...
		return $this->genericGet("proveedor");
	}
	...
	function post()
	{
		...
		try
		{
			$proveedor = app::getUserFromSession();
			if( $proveedor == null )
	...
	{
		return $this->genericInsert($array,"proveedor");
	}

	function batchUpdate($array)
	{
		$insert_with_ids = false;
		return $this->genericUpdate($array, "proveedor", $insert_with_ids );
	}
