...
class Service extends SuperRest
{
	function get()
	{
		...
		return $this->genericGet("cotizacion_programada");
	}
	...
	function post()
	{
		...
		try
		{
			$cotizacion_programada = app::getUserFromSession();
			if( $cotizacion_programada == null )
	...
	{
		return $this->genericInsert($array,"cotizacion_programada");
	}

	function batchUpdate($array)
	{
		$insert_with_ids = false;
		return $this->genericUpdate($array, "cotizacion_programada", $insert_with_ids );
	}
