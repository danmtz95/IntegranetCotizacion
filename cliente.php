...
class Service extends SuperRest
{
	function get()
	{
		...
		return $this->genericGet("cliente");
	}
	...
	function post()
	{
		...
		try
		{
			$cliente = app::getUserFromSession();
			if( $cliente == null )
	...
	{
		return $this->genericInsert($array,"cliente");
	}

	function batchUpdate($array)
	{
		$insert_with_ids = false;
		return $this->genericUpdate($array, "cliente", $insert_with_ids );
	}
