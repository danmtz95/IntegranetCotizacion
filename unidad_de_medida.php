...
class Service extends SuperRest
{
	function get()
	{
		...
		return $this->genericGet("unidad_de_medida");
	}
	...
	function post()
	{
		...
		try
		{
			$unidad_de_medida = app::getUserFromSession();
			if( $unidad_de_medida == null )
	...
	{
		return $this->genericInsert($array,"unidad_de_medida");
	}

	function batchUpdate($array)
	{
		$insert_with_ids = false;
		return $this->genericUpdate($array, "unidad_de_medida", $insert_with_ids );
	}
