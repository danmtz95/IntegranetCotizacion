...
class Service extends SuperRest
{
	function get()
	{
		...
		return $this->genericGet("sucursal");
	}
	...
	function post()
	{
		...
		try
		{
			$sucursal = app::getUserFromSession();
			if( $sucursal == null )
	...
	{
		return $this->genericInsert($array,"sucursal");
	}

	function batchUpdate($array)
	{
		$insert_with_ids = false;
		return $this->genericUpdate($array, "sucursal", $insert_with_ids );
	}
